...
import imageBlack from '../images/BlackRook.png';
import imageWhite from '../images/WhiteRook.png';
...
function Rook(props){
    ...
    function handleMouseRelease(e)
    {
        ...
        let originalLocation = props.moveMade({x: e.clientX -20, y: e.clientY-20}, 'Rook', props.loc, props.color);
        if(originalLocation)
        {
    ...
    return(
            <img className = "Img" draggable="true" ref={imgRef} onMouseEnter={handleHover} onMouseDown={handleMouseDown}src={image} alt='rook'/>
    )
};
export default Rook