...
import imageBlack from '../images/BlackKing.png';
import imageWhite from '../images/WhiteKing.png';
...
function King(props){
    ...
    function handleMouseRelease(e)
    {
        ...
        let originalLocation = props.moveMade({x: e.clientX -20, y: e.clientY-20}, 'King', props.loc, props.color);
        if(originalLocation)
        {
    ...
    return(
            <img className = "Img" draggable="true" ref={imgRef} onMouseEnter={handleHover} onMouseDown={handleMouseDown}src={image} alt='king'/>
    )
};
export default King