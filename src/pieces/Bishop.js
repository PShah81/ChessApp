...
import imageBlack from '../images/BlackBishop.png';
import imageWhite from '../images/WhiteBishop.png';
...
function Bishop(props){
    ...
    function handleMouseRelease(e)
    {
        ...
        let originalLocation = props.moveMade({x: e.clientX -20, y: e.clientY-20}, 'Bishop', props.loc, props.color);
        if(originalLocation)
        {
    ...
    return(
            <img className = "Img" draggable="true" ref={imgRef} onMouseEnter={handleHover} onMouseDown={handleMouseDown}src={image} alt='bishop'/>
    )
};
